...
public class Ragesaber extends Weapon
{

	public Ragesaber(int newLevel)
	{
		super(newLevel);
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Rage", 1);
	...
	{
		return new ArrayList<>(Arrays.asList(CellType.Utility, CellType.Defence));
	}
