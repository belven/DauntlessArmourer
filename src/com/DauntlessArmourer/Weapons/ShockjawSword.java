...
public class ShockjawSword extends Weapon
{

	public ShockjawSword(int newLevel)
	{
		super(newLevel);
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Energized", 2);
	...
	{
		return new ArrayList<>(Arrays.asList(CellType.Utility, CellType.Mobility));
	}
