...
public class DeadeyeLegs extends Armour
{

	public DeadeyeLegs(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Savagery", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("ShellshockResist", 1);
