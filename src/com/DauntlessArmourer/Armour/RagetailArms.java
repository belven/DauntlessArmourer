...
public class RagetailArms extends Armour
{

	public RagetailArms(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Ragehunter", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Tough", 1);
