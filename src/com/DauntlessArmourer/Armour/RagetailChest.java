...
public class RagetailChest extends Armour
{

	public RagetailChest(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Tough", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Bloodless", 1);
