...
public class RazorwingArms extends Armour
{

	public RazorwingArms(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Bladestorm", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Endurance", 1);
