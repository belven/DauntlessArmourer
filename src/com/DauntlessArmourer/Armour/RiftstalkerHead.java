...
public class RiftstalkerHead extends Armour
{

	public RiftstalkerHead(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Conduit", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("AethericAttunement", 1);
