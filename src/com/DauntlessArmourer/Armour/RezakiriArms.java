...
public class RezakiriArms extends Armour
{

	public RezakiriArms(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Cunning", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Agility", 1);
