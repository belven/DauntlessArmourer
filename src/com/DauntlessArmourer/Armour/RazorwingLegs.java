...
public class RazorwingLegs extends Armour
{

	public RazorwingLegs(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Deconstruction", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Bladestorm", 1);
