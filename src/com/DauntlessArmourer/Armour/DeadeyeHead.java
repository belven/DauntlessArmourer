...
public class DeadeyeHead extends Armour
{

	public DeadeyeHead(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("ShellshockResist", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Barbed", 1);
