...
public class RiftstalkerChest extends Armour
{

	public RiftstalkerChest(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("AethericAttunement", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Evasion", 1);
