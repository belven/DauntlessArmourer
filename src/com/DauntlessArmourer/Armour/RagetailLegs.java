...
public class RagetailLegs extends Armour
{

	public RagetailLegs(int newLevel)
	{
	...
	public ArrayList<Effect> getEffects()
	{
		...
		Effect effect1 = ArmourerFactory.getEffectByName("Bloodless", 1);
		Effect effect2 = ArmourerFactory.getEffectByName("Ragehunter", 1);
